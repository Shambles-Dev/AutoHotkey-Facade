    ...
    <td>
      <p>AutoHotkey contains operators that are defective:
        <ul>
          ...
          <li><code>X &lt;&lt; N</code> returns incorrect results when <code>N</code> is the bit width (e.g. <code>-2 &lt;&lt; 64</code> is <code>-2</code> instead of <code>0</code>)</li>
          <li><code>X &gt;&gt; N</code> returns incorrect results when <code>N</code> is the bit width (e.g. <code>-2 &gt;&gt; 64</code> is <code>-2</code> instead of <code>-1</code>)</li>
...
`Op_Expt(X, Y)` evaluates `X ** Y`.  0⁰ = 1 because many branches of math require that and none require otherwise.
...
`tau` [τ](https://en.wikipedia.org/wiki/Tau_(mathematical_constant)) is 2π.
